...
def keys():
    ...
    rospy.sleep(1)
    rate = rospy.Rate(100)#try removing this line and see what happens
    while not rospy.is_shutdown():
        k=ord(getch.getch())# this is used to convert the keypress event in the keyboard or joypad , joystick to a ord value
        if ((k==119)|(k==115)|(k==100)|(k==97)|(k==113) |(k==65) |(k==87) |(k==83) |(k==68) |(k==81)):# to filter only the up , dowm ,left , right key /// this line can be removed or more key can be added to this
