...
current_turtle = "turtle2"  # Default turtle
...
def keys():
    ...
    pub = rospy.Publisher('/turtle2_key', Int8, queue_size=10, latch=True)

    rospy.Subscriber('/chosen/turtle2', String, turtle_callback)
    ...
    while not rospy.is_shutdown():
        ...
        if k in [119, 115, 100, 97, 113, 65, 87, 83, 68, 81]:  # Filtered keys
            ...
            rospy.Publisher("/turtle2/key", Int8, queue_size=10, latch=True).publish(k)
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("turtle2_keyboard terminated")
