...
current_turtle = "turtle4"  # Default turtle
...
def keys():
    ...
    pub = rospy.Publisher('/turtle4_key', Int8, queue_size=10, latch=True)

    rospy.Subscriber('/chosen/turtle4', String, turtle_callback)
    ...
    while not rospy.is_shutdown():
        ...
        if k in [119, 115, 100, 97, 113, 65, 87, 83, 68, 81]:  # Filtered keys
            ...
            rospy.Publisher("/turtle4/key", Int8, queue_size=10, latch=True).publish(k)
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("turtle4_keyboard terminated")
